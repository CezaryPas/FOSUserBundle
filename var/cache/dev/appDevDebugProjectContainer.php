...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'authbucket_oauth2.authorization_controller' => 'getAuthbucketOauth2_AuthorizationControllerService',
            'authbucket_oauth2.debug_controller' => 'getAuthbucketOauth2_DebugControllerService',
            'authbucket_oauth2.exception_listener' => 'getAuthbucketOauth2_ExceptionListenerService',
            'authbucket_oauth2.grant_type_handler.factory' => 'getAuthbucketOauth2_GrantTypeHandler_FactoryService',
            'authbucket_oauth2.model_manager.factory' => 'getAuthbucketOauth2_ModelManager_FactoryService',
            'authbucket_oauth2.resource_type_handler.factory' => 'getAuthbucketOauth2_ResourceTypeHandler_FactoryService',
            'authbucket_oauth2.response_type_handler.factory' => 'getAuthbucketOauth2_ResponseTypeHandler_FactoryService',
            'authbucket_oauth2.token_controller' => 'getAuthbucketOauth2_TokenControllerService',
            'authbucket_oauth2.token_type_handler.factory' => 'getAuthbucketOauth2_TokenTypeHandler_FactoryService',
            ...
            'security.authentication.listener.resource' => 'getSecurity_Authentication_Listener_ResourceService',
            'security.authentication.listener.token' => 'getSecurity_Authentication_Listener_TokenService',
            'security.authentication.manager' => 'getSecurity_Authentication_ManagerService',
            'security.authentication.provider.anonymous.main' => 'getSecurity_Authentication_Provider_Anonymous_MainService',
            'security.authentication.provider.resource' => 'getSecurity_Authentication_Provider_ResourceService',
            'security.authentication.provider.token' => 'getSecurity_Authentication_Provider_TokenService',
    ...
    /**
     * Gets the 'authbucket_oauth2.authorization_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\Controller\AuthorizationController A AuthBucket\OAuth2\Controller\AuthorizationController instance
     */
    protected function getAuthbucketOauth2_AuthorizationControllerService()
    {
        return $this->services['authbucket_oauth2.authorization_controller'] = new \AuthBucket\OAuth2\Controller\AuthorizationController(${($_ = isset($this->services['validator']) ? $this->services['validator'] : $this->get('validator')) && false ?: '_'}, ${($_ = isset($this->services['authbucket_oauth2.response_type_handler.factory']) ? $this->services['authbucket_oauth2.response_type_handler.factory'] : $this->get('authbucket_oauth2.response_type_handler.factory')) && false ?: '_'});
    }

    /**
     * Gets the 'authbucket_oauth2.debug_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\Controller\DebugController A AuthBucket\OAuth2\Controller\DebugController instance
     */
    protected function getAuthbucketOauth2_DebugControllerService()
    {
        return $this->services['authbucket_oauth2.debug_controller'] = new \AuthBucket\OAuth2\Controller\DebugController(${($_ = isset($this->services['security.token_storage']) ? $this->services['security.token_storage'] : $this->get('security.token_storage')) && false ?: '_'});
    }

    /**
     * Gets the 'authbucket_oauth2.exception_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\Symfony\Component\EventDispatcher\ExceptionListener A AuthBucket\OAuth2\Symfony\Component\EventDispatcher\ExceptionListener instance
     */
    protected function getAuthbucketOauth2_ExceptionListenerService()
    {
        return $this->services['authbucket_oauth2.exception_listener'] = new \AuthBucket\OAuth2\Symfony\Component\EventDispatcher\ExceptionListener(${($_ = isset($this->services['logger']) ? $this->services['logger'] : $this->get('logger')) && false ?: '_'});
    }

    /**
     * Gets the 'authbucket_oauth2.grant_type_handler.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\GrantType\GrantTypeHandlerFactory A AuthBucket\OAuth2\GrantType\GrantTypeHandlerFactory instance
     */
    protected function getAuthbucketOauth2_GrantTypeHandler_FactoryService()
    {
        return $this->services['authbucket_oauth2.grant_type_handler.factory'] = new \AuthBucket\OAuth2\GrantType\GrantTypeHandlerFactory(${($_ = isset($this->services['security.token_storage']) ? $this->services['security.token_storage'] : $this->get('security.token_storage')) && false ?: '_'}, ${($_ = isset($this->services['security.encoder_factory']) ? $this->services['security.encoder_factory'] : $this->get('security.encoder_factory')) && false ?: '_'}, ${($_ = isset($this->services['validator']) ? $this->services['validator'] : $this->get('validator')) && false ?: '_'}, ${($_ = isset($this->services['authbucket_oauth2.model_manager.factory']) ? $this->services['authbucket_oauth2.model_manager.factory'] : $this->get('authbucket_oauth2.model_manager.factory')) && false ?: '_'}, ${($_ = isset($this->services['authbucket_oauth2.token_type_handler.factory']) ? $this->services['authbucket_oauth2.token_type_handler.factory'] : $this->get('authbucket_oauth2.token_type_handler.factory')) && false ?: '_'}, NULL, array('authorization_code' => 'AuthBucket\\OAuth2\\GrantType\\AuthorizationCodeGrantTypeHandler', 'client_credentials' => 'AuthBucket\\OAuth2\\GrantType\\ClientCredentialsGrantTypeHandler', 'password' => 'AuthBucket\\OAuth2\\GrantType\\PasswordGrantTypeHandler', 'refresh_token' => 'AuthBucket\\OAuth2\\GrantType\\RefreshTokenGrantTypeHandler'));
    }

    /**
     * Gets the 'authbucket_oauth2.model_manager.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\Model\InMemoryModelManagerFactory A AuthBucket\OAuth2\Model\InMemoryModelManagerFactory instance
     */
    protected function getAuthbucketOauth2_ModelManager_FactoryService()
    {
        return $this->services['authbucket_oauth2.model_manager.factory'] = new \AuthBucket\OAuth2\Model\InMemoryModelManagerFactory(array('access_token' => 'AuthBucket\\OAuth2\\Model\\InMemoryAccessToken'));
    }

    /**
     * Gets the 'authbucket_oauth2.resource_type_handler.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\ResourceType\ResourceTypeHandlerFactory A AuthBucket\OAuth2\ResourceType\ResourceTypeHandlerFactory instance
     */
    protected function getAuthbucketOauth2_ResourceTypeHandler_FactoryService()
    {
        return $this->services['authbucket_oauth2.resource_type_handler.factory'] = new \AuthBucket\OAuth2\ResourceType\ResourceTypeHandlerFactory(${($_ = isset($this->services['http_kernel']) ? $this->services['http_kernel'] : $this->get('http_kernel')) && false ?: '_'}, ${($_ = isset($this->services['authbucket_oauth2.model_manager.factory']) ? $this->services['authbucket_oauth2.model_manager.factory'] : $this->get('authbucket_oauth2.model_manager.factory')) && false ?: '_'}, array('model' => 'AuthBucket\\OAuth2\\ResourceType\\ModelResourceTypeHandler', 'debug_endpoint' => 'AuthBucket\\OAuth2\\ResourceType\\DebugEndpointResourceTypeHandler'));
    }

    /**
     * Gets the 'authbucket_oauth2.response_type_handler.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\ResponseType\ResponseTypeHandlerFactory A AuthBucket\OAuth2\ResponseType\ResponseTypeHandlerFactory instance
     */
    protected function getAuthbucketOauth2_ResponseTypeHandler_FactoryService()
    {
        return $this->services['authbucket_oauth2.response_type_handler.factory'] = new \AuthBucket\OAuth2\ResponseType\ResponseTypeHandlerFactory(${($_ = isset($this->services['security.token_storage']) ? $this->services['security.token_storage'] : $this->get('security.token_storage')) && false ?: '_'}, ${($_ = isset($this->services['validator']) ? $this->services['validator'] : $this->get('validator')) && false ?: '_'}, ${($_ = isset($this->services['authbucket_oauth2.model_manager.factory']) ? $this->services['authbucket_oauth2.model_manager.factory'] : $this->get('authbucket_oauth2.model_manager.factory')) && false ?: '_'}, ${($_ = isset($this->services['authbucket_oauth2.token_type_handler.factory']) ? $this->services['authbucket_oauth2.token_type_handler.factory'] : $this->get('authbucket_oauth2.token_type_handler.factory')) && false ?: '_'}, array('code' => 'AuthBucket\\OAuth2\\ResponseType\\CodeResponseTypeHandler', 'token' => 'AuthBucket\\OAuth2\\ResponseType\\TokenResponseTypeHandler'));
    }

    /**
     * Gets the 'authbucket_oauth2.token_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\Controller\TokenController A AuthBucket\OAuth2\Controller\TokenController instance
     */
    protected function getAuthbucketOauth2_TokenControllerService()
    {
        return $this->services['authbucket_oauth2.token_controller'] = new \AuthBucket\OAuth2\Controller\TokenController(${($_ = isset($this->services['validator']) ? $this->services['validator'] : $this->get('validator')) && false ?: '_'}, ${($_ = isset($this->services['authbucket_oauth2.grant_type_handler.factory']) ? $this->services['authbucket_oauth2.grant_type_handler.factory'] : $this->get('authbucket_oauth2.grant_type_handler.factory')) && false ?: '_'});
    }

    /**
     * Gets the 'authbucket_oauth2.token_type_handler.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\TokenType\TokenTypeHandlerFactory A AuthBucket\OAuth2\TokenType\TokenTypeHandlerFactory instance
     */
    protected function getAuthbucketOauth2_TokenTypeHandler_FactoryService()
    {
        return $this->services['authbucket_oauth2.token_type_handler.factory'] = new \AuthBucket\OAuth2\TokenType\TokenTypeHandlerFactory(${($_ = isset($this->services['validator']) ? $this->services['validator'] : $this->get('validator')) && false ?: '_'}, ${($_ = isset($this->services['authbucket_oauth2.model_manager.factory']) ? $this->services['authbucket_oauth2.model_manager.factory'] : $this->get('authbucket_oauth2.model_manager.factory')) && false ?: '_'}, array('bearer' => 'AuthBucket\\OAuth2\\TokenType\\BearerTokenTypeHandler', 'mac' => 'AuthBucket\\OAuth2\\TokenType\\MacTokenTypeHandler'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', /** @closure-proxy AuthBucket\OAuth2\Symfony\Component\EventDispatcher\ExceptionListener::onKernelException */ function (\Symfony\Component\HttpKernel\Event\GetResponseForExceptionEvent $event) {
            return ${($_ = isset($this->services['authbucket_oauth2.exception_listener']) ? $this->services['authbucket_oauth2.exception_listener'] : $this->get('authbucket_oauth2.exception_listener')) && false ?: '_'}->onKernelException($event);
        }, -2);
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/vendor/authbucket/oauth2-symfony-bundle/src/Entity'), 1 => ($this->targetDirs[3].'/src/OAuth2Bundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AuthBucket\\Bundle\\OAuth2Bundle\\Entity');
        $c->addDriver($b, 'OAuth2Bundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('AuthBucketOAuth2Bundle' => 'AuthBucket\\Bundle\\OAuth2Bundle\\Entity', 'OAuth2Bundle' => 'OAuth2Bundle\\Entity'));
    ...
    /**
     * Gets the 'security.authentication.listener.resource' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\Symfony\Component\Security\Http\Firewall\ResourceListener A AuthBucket\OAuth2\Symfony\Component\Security\Http\Firewall\ResourceListener instance
     */
    protected function getSecurity_Authentication_Listener_ResourceService()
    {
        return $this->services['security.authentication.listener.resource'] = new \AuthBucket\OAuth2\Symfony\Component\Security\Http\Firewall\ResourceListener(NULL, ${($_ = isset($this->services['security.token_storage']) ? $this->services['security.token_storage'] : $this->get('security.token_storage')) && false ?: '_'}, ${($_ = isset($this->services['security.authentication.manager']) ? $this->services['security.authentication.manager'] : $this->getSecurity_Authentication_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['validator']) ? $this->services['validator'] : $this->get('validator')) && false ?: '_'}, ${($_ = isset($this->services['logger']) ? $this->services['logger'] : $this->get('logger')) && false ?: '_'}, ${($_ = isset($this->services['authbucket_oauth2.token_type_handler.factory']) ? $this->services['authbucket_oauth2.token_type_handler.factory'] : $this->get('authbucket_oauth2.token_type_handler.factory')) && false ?: '_'});
    }

    /**
     * Gets the 'security.authentication.listener.token' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\Symfony\Component\Security\Http\Firewall\TokenListener A AuthBucket\OAuth2\Symfony\Component\Security\Http\Firewall\TokenListener instance
     */
    protected function getSecurity_Authentication_Listener_TokenService()
    {
        return $this->services['security.authentication.listener.token'] = new \AuthBucket\OAuth2\Symfony\Component\Security\Http\Firewall\TokenListener(NULL, ${($_ = isset($this->services['security.token_storage']) ? $this->services['security.token_storage'] : $this->get('security.token_storage')) && false ?: '_'}, ${($_ = isset($this->services['security.authentication.manager']) ? $this->services['security.authentication.manager'] : $this->getSecurity_Authentication_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['validator']) ? $this->services['validator'] : $this->get('validator')) && false ?: '_'}, ${($_ = isset($this->services['logger']) ? $this->services['logger'] : $this->get('logger')) && false ?: '_'});
    }

    /**
     * Gets the 'security.authentication.provider.resource' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\Symfony\Component\Security\Core\Authentication\Provider\ResourceProvider A AuthBucket\OAuth2\Symfony\Component\Security\Core\Authentication\Provider\ResourceProvider instance
     */
    protected function getSecurity_Authentication_Provider_ResourceService()
    {
        return $this->services['security.authentication.provider.resource'] = new \AuthBucket\OAuth2\Symfony\Component\Security\Core\Authentication\Provider\ResourceProvider(NULL, ${($_ = isset($this->services['authbucket_oauth2.resource_type_handler.factory']) ? $this->services['authbucket_oauth2.resource_type_handler.factory'] : $this->get('authbucket_oauth2.resource_type_handler.factory')) && false ?: '_'}, NULL, NULL, NULL);
    }

    /**
     * Gets the 'security.authentication.provider.token' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AuthBucket\OAuth2\Symfony\Component\Security\Core\Authentication\Provider\TokenProvider A AuthBucket\OAuth2\Symfony\Component\Security\Core\Authentication\Provider\TokenProvider instance
     */
    protected function getSecurity_Authentication_Provider_TokenService()
    {
        return $this->services['security.authentication.provider.token'] = new \AuthBucket\OAuth2\Symfony\Component\Security\Core\Authentication\Provider\TokenProvider(NULL, ${($_ = isset($this->services['authbucket_oauth2.model_manager.factory']) ? $this->services['authbucket_oauth2.model_manager.factory'] : $this->get('authbucket_oauth2.model_manager.factory')) && false ?: '_'});
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/OAuth2Bundle/Resources/views'), 'OAuth2');
    ...
    {
        return $this->services['cache.serializer.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L9OO6wDpkB', 0, '74kqajz2thSV96JRvAFT-3', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TjcjaJtG3n', 0, '74kqajz2thSV96JRvAFT-3', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9wm3ErQNE5', 0, '74kqajz2thSV96JRvAFT-3', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a9507d9da1ee4.70817311');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'AuthBucketOAuth2Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/authbucket/oauth2-symfony-bundle/src'),
                    'namespace' => 'AuthBucket\\Bundle\\OAuth2Bundle',
                ),
                'OAuth2Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/OAuth2Bundle'),
                    'namespace' => 'OAuth2Bundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AuthBucketOAuth2Bundle' => 'AuthBucket\\Bundle\\OAuth2Bundle\\AuthBucketOAuth2Bundle',
                'OAuth2Bundle' => 'OAuth2Bundle\\OAuth2Bundle',
            ...
            'authbucket_oauth2.token_type_handler' => array(
                'bearer' => 'AuthBucket\\OAuth2\\TokenType\\BearerTokenTypeHandler',
                'mac' => 'AuthBucket\\OAuth2\\TokenType\\MacTokenTypeHandler',
            ),
            'authbucket_oauth2.resource_type_handler' => array(
